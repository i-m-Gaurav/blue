    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-[#2563EB] font-semibold mb-2">Self-Paced Learning</p>
          ...
          {recordedCourses.map((course, index) => (
            <div
              ...
              className={`bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105 ${
                index === 1 ? 'lg:scale-110 lg:z-10 ring-2 ring-blue-200' : ''
              }`}
            >
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-[#2563EB] text-white px-2 py-1 rounded-full text-xs font-medium">
                  {course.level}
                </div>
              ...
              <div className="p-6">
                ...
                <Link
                  to={`/course/${course.id}`}
                  className="w-full bg-[#2563EB] text-white py-3 px-6 rounded-full font-semibold hover:bg-blue-700 transition-colors text-center block"
                >
                  Enroll Now
                </Link>
              </div>
