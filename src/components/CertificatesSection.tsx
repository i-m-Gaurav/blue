        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-3xl shadow-lg">
              <div className="bg-white p-8 rounded-2xl border-4 border-blue-200 relative overflow-hidden">
                {/* Decorative Elements */}
                ...
                <div className="relative text-center">
                  ...
                  <div className="mb-6">
                    <h4 className="text-3xl font-bold text-[#2563EB] mb-2">Rohit Kumar</h4>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="text-right">
                      <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-2">
                        <span className="text-xs font-bold text-[#2563EB]">VERIFIED</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex justify-center gap-4 mt-6">
              ...
              <button className="flex items-center gap-2 border-2 border-blue-600 text-[#2563EB] px-6 py-3 rounded-full hover:bg-blue-50 transition-colors">
